...
import {GoogleFontConfig} from '@common/core/services/value-lists.service';
    ...
    implements OnInit, OnDestroy, ControlValueAccessor
{
    ...
    chunkedFonts$ = new BehaviorSubject<GoogleFontConfig[][]>(null);
    ...
    fonts$: Observable<GoogleFontConfig[]> = combineLatest(
        this.activePage$,
        this.chunkedFonts$
    ).pipe(
    ...
    private allFonts: GoogleFontConfig[];
    private perPage = 20;
    ...
    private chunkFonts(fonts: GoogleFontConfig[]) {
    ...
    private loadIntoDom(fonts: GoogleFontConfig[]) {
